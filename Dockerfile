...
RUN unzip  ./target/gatewayserver-0.0.1-SNAPSHOT.jar -d ./target/extracted
...
RUN jdeps --ignore-missing-deps -q  \
    ...
    ./target/gatewayserver-0.0.1-SNAPSHOT.jar > deps.info
...
RUN mkdir /opt/app
COPY --from=jar-build /app/target/gatewayserver-0.0.1-SNAPSHOT.jar /opt/app/
CMD ["java", "-jar", "/opt/app/gatewayserver-0.0.1-SNAPSHOT.jar"]
